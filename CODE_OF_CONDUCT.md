...
TerminalX a harassment-free experience for everyone, regardless of age,
...
- Publishing others' private information (physical/email address) without
  explicit permission
...
issues/PRs, Discord (if/when it exists), and in-person or virtual events
...
be reported to the maintainers at `connect@fantomlabs.io`. All
